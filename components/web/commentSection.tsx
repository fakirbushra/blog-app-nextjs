  ...
  return (
    <Card>
        <CardHeader className="flex flex-row items-center gap-2 border-b">
            ...
            <h1 className="text-xl font-bold">{data.length === 1 ? data.length + " Comment" : data.length + " Comments"}</h1>
        </CardHeader>
        ...
        <CardContent className="space-y-8">
            <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
                <Controller name='body' control={form.control} render={({field, fieldState}) => (
                    ...
                    <Textarea aria-invalid={fieldState.invalid} placeholder='Type your comment' {...field} />
