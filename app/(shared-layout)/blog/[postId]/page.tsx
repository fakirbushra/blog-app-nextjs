...
export default async function PostIdRoute({params}: PostIdRouteProps) {
    ...
    if (!post) {
        return (
            <div className="text-5xl font-bold text-red-500 py-20">Post Not Found!</div>
        )
    }

    return (
        <div className="relative max-w-3xl mx-auto py-8 px-4 animate-in fade-in duration-500">
